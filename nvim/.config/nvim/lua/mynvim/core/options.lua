...
local options = {
    ...
    signcolumn = "yes",        -- always show the sign column, otherwise it would shift the text each time (screen would jump)
    wrap = true,               -- display lines as one long line
    cursorline = true,         -- highlight the current line
    cursorlineopt = "number",  -- but not the whole line..I find it distracting
    ...
    colorcolumn = "92",        -- display column width indicator
    textwidth = 92,
